...
class OrderItemAdminInline(admin.TabularInline):
    model = OrderItem
    readonly_fields = ('product', 'quantity', 'price', 'printful_product_id', 'printful_variant_id', 'estimated_shipping_date')
...
class OrderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = (
        ...
        'printful_order_id', 'estimated_shipping_date', 'country'
    )
